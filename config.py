...
regexes = [
    ...
    re.compile(r'(при|о|а|пре|по|на|не|ни| |^)ху(есос|еплет|ев|ёв|ел|йн|ет|й|я|ю|и|ен|ец|цом|ца|цы)(аст|)(л|)(чик|еньк|ат|)(ани|)(я| ая|ый|ой|ому|о|а|ы|ой|я|и|е|й|ей|ю|ем|ый|ого|ому|ом|)', re.I),
